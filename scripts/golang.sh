...
sudo echo 'export GOROOT=/usr/local/go' >> /home/$USER/.bashrc
sudo echo 'export GOPATH=$HOME/go' >> /home/$USER/.bashrc
sudo echo 'export PATH=${PATH}:${GOROOT}/bin' >> /home/$USER/.bashrc
sudo echo 'export PATH=${PATH}:${GOPATH}/bin' >> /home/$USER/.bashrc
